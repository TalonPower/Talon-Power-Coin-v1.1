...
!win32 {
    ...
    genleveldb.commands = cd $$PWD/src/leveldb && CC=$$QMAKE_CC RANLIB=/mnt/mxe/usr/bin/i686-w64-mingw32.static-ranlib CXX=$$QMAKE_CXX $(MAKE) OPT=\"$$QMAKE_CXXFLAGS $$QMAKE_CXXFLAGS_RELEASE\" libleveldb.a libmemenv.a
} else {
